...
int grid_length = 5;      //Set grid length
color[] grid_color;        //Array storing all the corresponding colors for the movement pattern
ArrayList<Integer>movement = new ArrayList<Integer>();   //Array storing the movement pattern where 0 = left, 1 = right
int num_of_moves = 0;  //Set number of moves in the movement pattern
int dir = 3;               //Check the direction of the turmite where 0 = North, 1 = East, 2 = South, 3 = West
int dps = 1000;              //Number of times draw() is looped during one frame
int fps = 120;             //Frame rate
